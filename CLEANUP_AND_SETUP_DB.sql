...
TRUNCATE TABLE IF EXISTS public.avisos CASCADE;
TRUNCATE TABLE IF EXISTS public.alertas_bairro CASCADE;
TRUNCATE TABLE IF EXISTS public.configuracoes_notificacao CASCADE;
TRUNCATE TABLE IF EXISTS public.status_historico CASCADE;
TRUNCATE TABLE IF EXISTS public.solicitacoes CASCADE;
TRUNCATE TABLE IF EXISTS public.estruturas_culturais CASCADE;
TRUNCATE TABLE IF EXISTS public.demandas CASCADE;
TRUNCATE TABLE IF EXISTS public.obras CASCADE;
TRUNCATE TABLE IF EXISTS public.users CASCADE;

-- Passo 3: Dropar todas as tabelas
...
-- Passo 4: Dropar funções e triggers
DROP FUNCTION IF EXISTS public.trigger_set_timestamp() CASCADE;

-- Passo 5: Criar a função timestamp
...
-- ============================================================================
-- Descomentar para adicionar usuário admin padrão
-- INSERT INTO public.users (username, password, role, email)
-- VALUES ('admin', '$2b$10$N8I4JU4O6WGedek.MZqy1uHDy4QXAcblRDj96yGn1/YfT1j9YqFkS', 'admin', 'admin@example.com')
